...
public class BlazorPathHelperSourceGenerator : IIncrementalGenerator
{
    ...
    {
        // register attribute for BlazorPathAttribute
        var blazorPathAttrSources = context
            .SyntaxProvider.ForAttributeWithMetadataName(
                "BlazorPathHelper.BlazorPathAttribute",
                static (_, _) => true,
                static (context, _) => context
            )
            // Collect here to allow subsequent processing to proceed
            // even if BlazorPathAttribute does not exist
            .Collect();
        ...
        var sourceRoot = blazorPathAttrSources.Combine(razorFileStructures);
    ...
    {
        var (sources, structures) = pairs;
        ExportTemplateCode(context);
        ExportRazorStaticBuilderCode(context, structures);
    ...
    private static void ExportRazorStaticBuilderCode(
        SourceProductionContext context,
        ImmutableArray<ParseRazorStructure> structures
    )
    {
    ...
    private static void ExportTemplateCode(SourceProductionContext context)
    {
        var code = $$"""
            // <auto-generated />
            #nullable enable
            ...
            /// </summary>
            internal static class BlazorPathHelperUtility
            {
                /// <summary>
            ...
            """;
        context.AddSource($"BPH_Template.g.cs", code);
    }
}
