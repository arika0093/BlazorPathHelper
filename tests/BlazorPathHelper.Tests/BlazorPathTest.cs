...
public class BlazorPathTest
{
    ...
    private readonly BlazorPathMenuItem[] ExpectedMenu = [
        new(){
            Index = 0, GroupKey = "", GroupIndex = 0, GroupLevel = 0, Name = "TopPage", Path = "/", Icon = "",
            Children = []
        },
        new(){
        ...
        new(){
            ...
            [
                new(){
                    ...
                    Path = "/sample2/sub1", Icon = "", Children = []
                }
            ]
        },
        new(){
